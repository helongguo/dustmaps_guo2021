...
class Schultheis2014Query(UnstructuredDustMap):
    """
    ...
    def __init__(self, map_fname=None,color='Jk'):
        ...
        if map_fname is None:
            map_fname = os.path.join(data_dir(), 'schultheis2014', 'schultheis2014.fits')
        ...
        super(Schultheis2014Query, self).__init__(coords, max_pix_scale, metric_p=2)
...
def fetch(clobber=False):
    ...
    Args:
        clobber (Optional[bool]): If ``True``, any existing file will be
            ...
            corruption.
    """
    dest_dir = fname_pattern = os.path.join(data_dir(), 'schultheis2014')
    table_fname = os.path.join(dest_dir, 'schultheis2014.fits')
    ...
    url = 'http://paperdata.china-vo.org/guo/dust/schultheis2014.zip'
    archive_fname = os.path.join(dest_dir, 'schultheis2014.zip')
    archive_md5sum = 'd7830ce0b8819e68cd931ba4e520e396'
